[Documentation](https://github.com/VerifyTests/Verify.Mockly)
...
**See [Milestones](https://github.com/VerifyTests/Verify.Mockly/milestones?state=closed) for release notes.**
